...
class AtmPage:
    """Page object for ATM features in the Digital Bank App."""
    ...
    def __init__(self, driver):
        ...
        self.switch_off_1 = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeSwitch[`value == "0"`][1]')
        self.switch_off_2 = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeSwitch[`value == "0"`][2]')
        self.get_location_button = (
            AppiumBy.IOS_CLASS_CHAIN,
            '**/XCUIElementTypeStaticText[`name == "Get Location"`]'
        )
        self.zipcode_field = (
            AppiumBy.IOS_CLASS_CHAIN,
    ...
    def enter_zip_code(self, zip_code):
        """Enter ZIP code into alert field."""
